...
/* E32_400M20S  模块基础通信频率  */
#if defined(EBYTE_E32_400M20S)
#define   E32X_FREQUENCY_START                          434000000 // Hz 起始频率
/* E32_900M20S  模块基础通信频率  */
#elif defined(EBYTE_E32_900M20S)
#define   E32X_FREQUENCY_START                          915000000 // Hz 起始频率
#endif

#define   E32_MAX_SEND_NUM			  255

#define   E32X_MODULATION_TYPE         0   //调制方式 0:LoRa   
#define   E32X_OUTPUT_POWER           20   //最大输出 20dBm

#define   E32X_LORA_BANDWIDTH          9   //LoRa调制参数 频宽BW      [ 0: 7.8 kHz, 1: 10.4 kHz, 2: 15.6 kHz, 3: 20.8 kHz, 4: 31.2 kHz 5: 41.6 kHz, 6: 62.5 kHz, 7: 125 kHz, 8: 250 kHz, 9: 500 kHz ]
#define   E32X_LORA_SPREADING_FACTOR   7   //LoRa调制参数 扩频因子SF  [ 6: 64, 7: 128, 8: 256, 9: 512, 10: 1024, 11: 2048, 12: 4096  chips]
#define   E32X_LORA_CORING_RATE        1   //LoRa调制参数 编码率CR    [ 1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8 ]
#define   E32X_LORA_CRC                1   //CRC开关                  [ 0: OFF, 1: ON]
#define   E32X_LORA_LOW_DATARATE       1   //低空速优化开关            [ 0: OFF, 1: ON]
#define   E32X_LORA_PREAMBLE_LENGTH    6   //LoRa前导码长度  
#define   E32X_LORA_SYNC_WORD       0x12   //LoRa同步字       如果考虑采用LoRaWAN 可以修改为公共同步字: 0x34
