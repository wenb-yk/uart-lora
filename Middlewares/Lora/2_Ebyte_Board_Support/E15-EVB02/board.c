 ...
 * @brief 针对E19 普通引脚做初始化
 */
void Ebyte_BSP_E32xGPIO_Init( void )
{
    GPIO_Init( BSP_GPIO_PORT_E32_NRST, BSP_GPIO_PIN_E32_NRST, GPIO_Mode_Out_PP_High_Slow );  
    GPIO_Init( BSP_GPIO_PORT_E32_DIO0, BSP_GPIO_PIN_E32_DIO0, GPIO_Mode_In_PU_No_IT );
    GPIO_Init( BSP_GPIO_PORT_E32_RXEN, BSP_GPIO_PIN_E32_RXEN, GPIO_Mode_Out_PP_Low_Slow );   
    GPIO_Init( BSP_GPIO_PORT_E32_TXEN, BSP_GPIO_PIN_E32_TXEN, GPIO_Mode_Out_PP_Low_Slow );   
    GPIO_ExternalPullUpConfig( BSP_GPIO_PORT_E32_NRST, BSP_GPIO_PIN_E32_NRST, ENABLE );
    GPIO_ExternalPullUpConfig( BSP_GPIO_PORT_E32_RXEN, BSP_GPIO_PIN_E32_RXEN, ENABLE );
    GPIO_ExternalPullUpConfig( BSP_GPIO_PORT_E32_TXEN, BSP_GPIO_PIN_E32_TXEN, ENABLE );
}
...
#elif defined(EBYTE_E30_400M20S)||defined(EBYTE_E30_900M20S)
    Ebyte_BSP_E30xGPIO_Init();    
#elif defined(EBYTE_E31_400M17S)||defined(EBYTE_E31_900M17S)
    Ebyte_BSP_E31xGPIO_Init();    
#elif defined(EBYTE_E32_400M20S)||defined(EBYTE_E32_900M20S)    
    Ebyte_BSP_E32xGPIO_Init();
...
//        {
//        	case BSP_LED_R :
//                HAL_GPIO_WritePin( LED_R_GPIO_Port, LED_R_Pin, !!ctl );
//                break;
//            case BSP_LED_G :
//                HAL_GPIO_WritePin( LED_G_GPIO_Port, LED_G_Pin, !!ctl );
//                break;
//			case BSP_LED_B :
//                HAL_GPIO_WritePin( LED_B_GPIO_Port, LED_B_Pin, !!ctl );
//                break;
//            default:
//                break;
//        }
...
{
    uint8_t i;
    HAL_UART_Transmit(&huart1, buffer, length, 0x00FFFFFF);
//    for( i = 0; i < length; i++ )
//    {
