...
#define BSP_GPIO_PORT_E19_DIO0        GPIOD
#define BSP_GPIO_PIN_E19_DIO0         GPIO_Pin_4
#define BSP_GPIO_PORT_E19_RXEN        GPIOC
#define BSP_GPIO_PIN_E19_RXEN         GPIO_Pin_1
...
/* E32  */
#define BSP_GPIO_PORT_E32_NRST        GPIOC
#define BSP_GPIO_PIN_E32_NRST         GPIO_Pin_0
#define BSP_GPIO_PORT_E32_DIO0        GPIOD
#define BSP_GPIO_PIN_E32_DIO0         GPIO_Pin_4
#define BSP_GPIO_PORT_E32_RXEN        GPIOC
#define BSP_GPIO_PIN_E32_RXEN         GPIO_Pin_1
#define BSP_GPIO_PORT_E32_TXEN        GPIOC
#define BSP_GPIO_PIN_E32_TXEN         GPIO_Pin_2
/* E49 */
...
#define BSP_GPIO_PORT_SPI_NSS       GPIOB
#define BSP_GPIO_PIN_SPI_NSS        GPIO_PIN_0
/* 参数配置 SPI */
#define BSP_RF_SPI                  SPI1
#define BSP_RF_SPI_CLOCK            CLK_Peripheral_SPI1
#define Ebyte_BSP_RfSpiSelected()   HAL_GPIO_WritePin( BSP_GPIO_PORT_SPI_NSS , BSP_GPIO_PIN_SPI_NSS, 0 )
#define Ebyte_BSP_RfSpiUnselected() HAL_GPIO_WritePin( BSP_GPIO_PORT_SPI_NSS , BSP_GPIO_PIN_SPI_NSS, 1 )
...
#define Ebyte_BSP_E32ResetIoLow()  HAL_GPIO_WritePin( E32_RESET_GPIO_Port , E32_RESET_Pin, 0 )
#define Ebyte_BSP_E32ResetIoHigh() HAL_GPIO_WritePin( E32_RESET_GPIO_Port , E32_RESET_Pin, 1 )
#define Ebyte_BSP_E32TxIoDisable() HAL_GPIO_WritePin( E32_TXEN_GPIO_Port , E32_TXEN_Pin, 0 )
#define Ebyte_BSP_E32TxIoEnable()  HAL_GPIO_WritePin( E32_TXEN_GPIO_Port , E32_TXEN_Pin, 1 )
#define Ebyte_BSP_E32RxIoDisable() HAL_GPIO_WritePin( E32_RXEN_GPIO_Port , E32_RXEN_Pin, 0 )
#define Ebyte_BSP_E32RxIoEnable()  HAL_GPIO_WritePin( E32_RXEN_GPIO_Port , E32_RXEN_Pin, 1 ) 
#define Ebyte_BSP_E32Dio0Read()    //HAL_GPIO_ReadPin( E32_DIO0_GPIO_Port , E32_DIO0_Pin)
/* E49 */
...
#define DEBUG(...)     
#endif
typedef enum { BSP_LED_R = 0, BSP_LED_G, BSP_LED_B} BSP_LED_t;
